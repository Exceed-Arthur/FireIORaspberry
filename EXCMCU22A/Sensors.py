...
class I2CSensor(HomeSenseUnit):
    def __int__(self, SDA_PIN=I2C_PIN.SDA1, SCL_PIN=I2C_PIN.SCL1):
...
class ProximitySensor(DigitalSensor):  # High if someone present during read
    def __init__(self, SIGNAL_PIN=GPIO_PIN.PROXIMITY_SENSOR, HIGH_SIGNALS=0, SIGNAL_THRESHOLD=PROXIMITY_THRESHOLD):
        # call parent constructor to set MAX_VALUE and READ_COUNT
